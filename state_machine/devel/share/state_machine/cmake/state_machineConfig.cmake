...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/sb161/ros_labs_ws/src/lab_solution/state_machine)
  set(state_machine_DEVEL_PREFIX /home/sb161/ros_labs_ws/src/lab_solution/state_machine/devel)
...
if(NOT "/home/sb161/ros_labs_ws/src/lab_solution/state_machine/src " STREQUAL " ")
  set(state_machine_INCLUDE_DIRS "")
  set(_include_dirs "/home/sb161/ros_labs_ws/src/lab_solution/state_machine/src")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'sb161 <sb161@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sb161/ros_labs_ws/src/lab_solution/state_machine/${idir}'.  Ask the maintainer 'sb161 <sb161@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sb161/ros_labs_ws/src/lab_solution/state_machine/devel/lib;/home/sb161/turtlebot/devel/lib;/home/sb161/kobuki/devel/lib;/home/sb161/rocon/devel/lib;/opt/ros/indigo/lib)
